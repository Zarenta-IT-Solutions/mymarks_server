                ...
                <div class="rounded-t mb-0 px-4 py-3 border-0">
                    <div class="flex flex-wrap items-center">
                        <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                            <h3 class="font-semibold text-base text-gray-800">Users</h3>
                        </div>
                ...
                <div class="flex-auto px-4 bg-gray-100 lg:px-10 py-10 pt-0">
                    <table class="items-center w-full bg-transparent border-collapse" id="dataTable">
                        ...
                        <tr>
                            ...
                            <th class="px-3 align-middle border border-solid py-3 text-xs uppercase border-l-0 border-r-0 whitespace-no-wrap font-semibold text-left bg-gray-100 text-gray-600 border-gray-200">Email</th>
                            <th class="px-3 align-middle border border-solid py-3 text-xs uppercase border-l-0 border-r-0 whitespace-no-wrap font-semibold text-left bg-gray-100 text-gray-600 border-gray-200">Role</th>
...
@section('script')
    ...
    <script>
        $('#dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{route('school.users.index',['datatable'=>true])}}',
            columns: [
                ...
                {data: 'action', name: 'action', orderable: false, searchable: false, render:function (data,type,full,meta) {
                        console.log(full.id)
                        let id = full.id;
                        return ' <a href="{{route('school.users.index')}}/'+id+'/edit" class="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" ><i class="fa fa-edit"></i> Edit</a>';
                    }}
            ]
        });
    </script>
