...
<head>
    ...
    <title>MyMarks: Print Your Yearly Result</title>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-WX30TG32QF"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'G-WX30TG32QF');
    </script>
</head>
...
<nav class="top-0 absolute z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg" >
    <div class="container px-4 mx-auto flex flex-wrap items-center justify-between" >
        <div class="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start" >
            <a class="text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-no-wrap uppercase text-white"  href="{{url('/')}}" >MyMarks</a>
        </div>
                ...
                <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                        <div class="px-4 py-5 flex-auto">
                            ...
                            <h6 class="text-xl font-semibold">Data Entry</h6>
                            <p class="mt-2 mb-4 text-gray-600"> You need to enter the student's names, roll numbers, and scores into the software before printing the marksheet. </p>
                        </div>
                    </div>
                </div>
                <div class="w-full md:w-4/12 px-4 text-center">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg" >
                        <div class="px-4 py-5 flex-auto">
                            ...
                            <h6 class="text-xl font-semibold">Template Creation</h6>
                            <p class="mt-2 mb-4 text-gray-600"> A template for the marksheet needs to be created in the software, including layout, font, and formatting.</p>
                        </div>
                    </div>
                </div>
                <div class="pt-6 w-full md:w-4/12 px-4 text-center">
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg" >
                        <div class="px-4 py-5 flex-auto">
                            ...
                            <h6 class="text-xl font-semibold">Printing</h6>
                            <p class="mt-2 mb-4 text-gray-600">The software will merge the data and template, resulting in a marksheet document that can then be printed.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="flex flex-wrap items-center mt-32">
                <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
                    ...
                    <p  class="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700" >
                        A marksheet printing software is a tool used to create, edit, and print marksheets for students. It automates the process of generating marksheets, making it more efficient and less time-consuming than manual methods. Here are some of the key features and benefits of marksheet printing software:
                    </p>
                    ...
                    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-600" >
                        ...
                        <blockquote class="relative p-8 mb-4">
                            ...
                            <p class="text-md font-light mt-2 text-white">
                                Marksheet printing software can save time, reduce errors, and improve the accuracy and consistency of marksheet creation. It is commonly used by schools, colleges, and universities, and is available in various formats, including desktop, web-based, and cloud-based applications.
                            </p>
                        </blockquote>
                    </div>
                </div>
